...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $new_delivery_loc = $_POST["new_delivery_loc"];
    $new_delivery_pincode = $_POST["new_delivery_pincode"];

    // Update pickup_loc and pickup_pincode in item_details table
    $sql_update = "UPDATE item_details
                   SET deliver_loc = '$new_delivery_loc', deliver_pincode = '$new_delivery_pincode'
